...
<head>
    ...
    <title>Tableau de bord - DeclareTogo</title>
    ...
    <style>
        * {
        ...
        body.dark-mode .header-info .date-time {
        ...
        body.dark-mode .dashboard-title small {
            color: #94a3b8;
        }
...
<div class="main">
    ...
    <div class="dashboard-top">
        <div class="mobile-header">
            <button type="button" class="sidebar-toggle" onclick="toggleSidebar()" aria-label="Ouvrir le menu">
        ...
        <div class="header-right">
            <div class="header-info">
                ...
                <div class="preview-text">
                    <span>Dernière activité : {{ $dernieresDeclarations->count() }} déclarations visibles</span>
                </div>
            </div>
