...
<head>
    ...
    <title>Aide & FAQ - DeclareTogo</title>
    ...
    <div class="main-content">
        ...
        <div class="quick-links">
            <div class="quick-link-card" onclick="scrollToSection('faq-general')">
                <div class="quick-link-icon"><i class="bi bi-journal-bookmark-fill"></i></div>
            ...
            <div class="quick-link-card" onclick="scrollToSection('faq-compte')">
                <div class="quick-link-icon"><i class="bi bi-person-fill"></i></div>
                <h3>Mon Compte</h3>
                <p>Gestion de votre compte utilisateur</p>
            </div>
            <div class="quick-link-card" onclick="scrollToSection('faq-attestation')">
                <div class="quick-link-icon"><i class="bi bi-file-earmark-text-fill"></i></div>
                <h3>Attestations</h3>
        ...
        <div class="faq-section" id="faq-general">
            <h2><i class="bi bi-journal-bookmark-fill"></i> Questions Générales</h2>
            <div class="faq-item">
                <div class="faq-question" onclick="toggleFaq(this)">
                    <span>Qu'est-ce que DeclareTogo ?</span>
                    <i class="bi bi-chevron-down icon"></i>
                </div>
                <div class="faq-answer">
                    DeclareTogo est la plateforme officielle du gouvernement togolais permettant aux citoyens de déclarer en ligne la perte de leurs documents officiels (CNI, passeport, permis de conduire, etc.) et d'obtenir des attestations de déclaration de perte.
                </div>
            </div>
            <div class="faq-item">
                <div class="faq-question" onclick="toggleFaq(this)">
        ...
        <div class="faq-section" id="faq-declaration">
            <h2><i class="bi bi-pencil-square"></i> Faire une Déclaration</h2>
            <div class="faq-item">
                <div class="faq-question" onclick="toggleFaq(this)">
        ...
        <div class="faq-section" id="faq-compte">
            <h2><i class="bi bi-person-fill"></i> Mon Compte</h2>
            <div class="faq-item">
                <div class="faq-question" onclick="toggleFaq(this)">
        ...
        <div class="faq-section" id="faq-attestation">
            <h2><i class="bi bi-file-earmark-text-fill"></i> Attestations</h2>
            <div class="faq-item">
                <div class="faq-question" onclick="toggleFaq(this)">
        ...
        <div class="contact-section">
            <h2><i class="bi bi-telephone-fill"></i> Besoin d'une aide supplémentaire ?</h2>
