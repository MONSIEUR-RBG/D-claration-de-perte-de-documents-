...
<head>
    ...
    <title>Aide & Support - DeclareTogo</title>
    ...
    <style>
        * {
        ...
        :root {
            --flag-green: #006A36;
            --flag-green-dark: #004c28;
            --flag-green-light: #1e7a49;
            --flag-yellow: #FFCB00;
            --flag-red: #D21034;
            --flag-white: #FFFFFF;
            --primary: var(--flag-green);
            --primary-dark: var(--flag-green-dark);
            --primary-light: var(--flag-green-light);
...
<div class="main">
    ...
    <div class="help-header">
        <h1><i class="bi bi-question-circle-fill"></i> Centre d'aide</h1>
    ...
    <div class="help-tabs">
        <button class="help-tab active" onclick="showTab('faq')"><i class="bi bi-question-circle-fill"></i> FAQ</button>
        <button class="help-tab" onclick="showTab('guides')"><i class="bi bi-journal-text"></i> Guides</button>
        <button class="help-tab" onclick="showTab('contact')"><i class="bi bi-envelope-fill"></i> Contact</button>
    </div>
    ...
    <div class="tab-content active" id="faq-content">
        ...
        <div class="faq-item">
            ...
            <div class="faq-answer">
                <div class="faq-answer-content">
                    Oui, DeclareTogo est entièrement gratuit pour tous les citoyens togolais. Service public.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="tab-content" id="guides-content">
        <div class="guide-grid">
            ...
            <div class="guide-card" onclick="alert('Guide PDF bientôt disponible')">
                <div class="guide-icon"><i class="bi bi-file-earmark-text-fill"></i></div>
                <h3>Guide PDF</h3>
            ...
            <div class="guide-card" onclick="alert('Liste des pièces bientôt disponible')">
                <div class="guide-icon"><i class="bi bi-card-checklist"></i></div>
            ...
            <div class="guide-card" onclick="alert('Démarches administratives bientôt disponible')">
                <div class="guide-icon"><i class="bi bi-bank"></i></div>
    ...
    <div class="tab-content" id="contact-content">
        <div class="contact-info">
            <h3><i class="bi bi-telephone-fill"></i> Informations de contact</h3>
            <div class="contact-item"><div class="contact-item-icon"><i class="bi bi-envelope-fill"></i></div><div><strong>Email</strong><br>support@e-declaration.tg</div></div>
            <div class="contact-item"><div class="contact-item-icon"><i class="bi bi-phone-fill"></i></div><div><strong>Téléphone</strong><br>+228 90 00 00 00</div></div>
            <div class="contact-item"><div class="contact-item-icon"><i class="bi bi-clock-fill"></i></div><div><strong>Horaires</strong><br>Lun - Ven : 8h00 - 17h00</div></div>
            <div class="contact-item"><div class="contact-item-icon"><i class="bi bi-geo-alt-fill"></i></div><div><strong>Adresse</strong><br>Lomé, Togo</div></div>
        </div>
        ...
        <div class="contact-card">
            ...
            <form method="POST" action="{{ route('help.send') }}">
                ...
                <button type="submit" class="btn-primary">
                    <i class="bi bi-envelope-fill"></i> Envoyer le message
                </button>
            </form>
        </div>
    </div>
