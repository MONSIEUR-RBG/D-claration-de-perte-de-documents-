...
/* sidebar commun style fin  */
    ...
    .type-status-badge { padding:6px 15px; border-radius:6px; font-weight:600; font-size:0.85rem; }
...
<!-- <div class="d-flex">
    <div class="sidebar">
        <div class="sidebar-header"><h2><span>🇹🇬</span> DeclareTogo</h2></div>
        ...
        <div class="types-pieces-list">
            ...
            <div class="type-piece-card">
                <div class="type-card-header">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div>@if($type->is_active)<span class="type-status-badge bg-success text-white">Actif</span>@else<span class="type-status-badge bg-warning text-dark"> Inactif</span>@endif</div>
                        <div class="type-actions-header">
                            <button type="button" class="action-btn-header btn-info text-white" data-bs-toggle="modal" data-bs-target="#editTypePieceModal{{ $type->id }}"> Modifier</button>
                            <button type="button" class="action-btn-header btn-danger text-white" data-bs-toggle="modal" data-bs-target="#deleteTypePieceModal{{ $type->id }}"> Supprimer</button>
                        </div>
                    </div>
                </div>
                <div class="type-details-body">
            ...
            <div class="modal fade" id="editTypePieceModal{{ $type->id }}" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered modal-lg"><div class="modal-content">
                    <form method="POST" action="{{ route('admin.types-pieces.update', $type->id) }}">@csrf @method('PUT')
                        <div class="modal-header bg-warning"><h5 class="modal-title"> Modifier le type de pièce</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 mb-3"><label class="form-label">Nom du type *</label><input type="text" name="nom" class="form-control" value="{{ $type->nom }}" required></div>
                                <div class="col-md-6 mb-3"><label class="form-label">Code</label><input type="text" name="code" class="form-control" value="{{ $type->code }}"></div>
            ...
            <div class="modal fade" id="deleteTypePieceModal{{ $type->id }}" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered"><div class="modal-content">
                    <form method="POST" action="{{ route('admin.types-pieces.destroy', $type->id) }}">@csrf @method('DELETE')
                        <div class="modal-header bg-danger text-white"><h5 class="modal-title"> Confirmer la suppression</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div>
                        <div class="modal-body"><p>Êtes-vous sûr de vouloir supprimer <strong>{{ $type->nom }}</strong> ?</p><p class="text-danger"><small> Cette action est irréversible !</small></p></div>
                        <div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button><button type="submit" class="btn btn-danger">Supprimer</button></div>
                    </form>
                </div></div>
            </div>
