...
<head>
    ...
    <title>Déclarer un Document Trouvé - DeclareTogo</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1><i class="bi bi-box-seam"></i> Déclarer un Document Trouvé</h1>
            <p class="subtitle">Aidez quelqu'un à retrouver son document perdu</p>
        </div>

        <div class="alert-info">
            <div class="alert-info-icon"><i class="bi bi-info-circle-fill"></i></div>
            <div>
        ...
        <div class="form-card">
            <form action="{{ route('documents-trouves.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="section-title"><i class="bi bi-person-fill"></i> Vos Informations</div>
                <div class="form-grid">
                ...
                <div class="section-title"><i class="bi bi-file-earmark-text-fill"></i> Informations du Document Trouvé</div>
                <div class="form-grid">
                    <div class="form-group">
                ...
                <div class="section-title"><i class="bi bi-geo-alt-fill"></i> Où et Quand avez-vous trouvé ce document ?</div>
                <div class="form-grid">
                    <div class="form-group">
                ...
                <div class="section-title"><i class="bi bi-camera-fill"></i> Photo du Document (Optionnel)</div>
                <div class="form-group">
                    <div class="file-upload" onclick="document.getElementById('photo').click()">
                        ...
                        <div style="font-size: 3rem; margin-bottom: 1rem;"><i class="bi bi-camera-fill"></i></div>
                    ...
                    <span class="help-text"><i class="bi bi-exclamation-triangle-fill"></i> N'envoyez qu'une photo si nécessaire pour l'identification</span>
                </div>

                <button type="submit" class="btn-submit">
                    <i class="bi bi-check-circle-fill"></i> Déclarer ce Document Trouvé
                </button>
            </form>
        </div>
    </div>
        ...
        document.getElementById('photo').addEventListener('change', function(e) {
            if (e.target.files.length > 0) {
                ...
                fileUpload.innerHTML = `
                    <div style="font-size: 2rem; margin-bottom: 0.5rem;"><i class="bi bi-check-circle-fill"></i></div>
